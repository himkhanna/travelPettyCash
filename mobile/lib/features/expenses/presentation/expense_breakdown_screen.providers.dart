...
final FutureProviderFamily<List<ExpenseSummary>,
        ({String tripId, ExpenseGroupBy groupBy})> mySummaryProvider =
    FutureProvider.family<List<ExpenseSummary>,
  ...
  (Ref ref, ({String tripId, ExpenseGroupBy groupBy}) args) {
    ...
    return ref.read(expenseRepositoryProvider).summary(
          tripId: args.tripId,
